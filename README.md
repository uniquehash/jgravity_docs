...
At this point a lot of this project is not figured out. There are optimizations we are thinking about, but until we have some benchmarks of how much a single threaded program can handle, they seem difficult to concretize.
